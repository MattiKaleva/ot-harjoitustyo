...
public class MaksukorttiTest {
    ...
    @Test
    public void kortillaVoiSyodaEdullisestiTasarahalla() {
        Maksukortti syoEdullisestiKortti = new Maksukortti(2.5);
        syoEdullisestiKortti.syoEdullisesti();
        assertEquals("Kortilla on rahaa 0.0 euroa", syoEdullisestiKortti.toString());
    }
    @Test
    public void kortillaVoiSyodaMaukkaastiTasarahalla() {
        Maksukortti syoMaukkaastiKortti = new Maksukortti(4);
